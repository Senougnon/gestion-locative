...
addMaisonForm.addEventListener("submit", (event) => {
    ...
    const type_construction = document.getElementById("maison-type-construction").value;
    ...
    addMaison(proprietaireId, type, type_construction, numero, pieces, ville, commune, quartier, loyer)
      .then(() => {
...
async function addMaison(proprietaireId, type, type_construction, numero, pieces, ville, commune, quartier, loyer) {
